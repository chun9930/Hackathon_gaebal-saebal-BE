package com.mcm.privatecircle.purchase.controller;
...
public class PurchaseController {
    ...
    public ResponseEntity<ApiResponse<PurchaseResponse>> createPurchase(
        ...
        return ResponseEntity.status(HttpStatus.CREATED)
            .body(ApiResponse.success(purchaseService.createPurchase(authenticatedUser, request)));
    }

    @GetMapping("/customers/{customerId}/purchases")
    @PreAuthorize("hasRole('CA')")
    public ResponseEntity<ApiResponse<PageResponse<PurchaseResponse>>> getCustomerPurchases(
        @AuthenticationPrincipal AuthenticatedUser authenticatedUser,
        ...
        return ResponseEntity.ok(ApiResponse.success(
            purchaseService.getCustomerPurchases(authenticatedUser, customerId, page, size)
        ));
    }
}
