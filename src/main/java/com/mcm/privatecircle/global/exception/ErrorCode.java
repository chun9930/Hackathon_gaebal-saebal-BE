...
public enum ErrorCode {
    ...
    INTEREST_PRODUCT_NOT_FOUND(HttpStatus.NOT_FOUND, "INTEREST_PRODUCT_NOT_FOUND", "관심 상품을 찾을 수 없습니다."),
    AI_BRIEF_NOT_FOUND(HttpStatus.NOT_FOUND, "AI_BRIEF_NOT_FOUND", "AI 브리프를 찾을 수 없습니다."),
